...
const tables = [
  ...
  },
  {
    ...
    revLinks: [
      ...
      { column: "organisation", table: "departments" },
    ],
  },
  {
    name: "members",
  ...
  },
  {
    ...
    revLinks: [
      ...
      { column: "department", table: "activities" },
    ],
  },
  {
    name: "categories",
    ...
    revLinks: [{ column: "category", table: "activities" }],
  },
  {
    name: "activities",
    columns: [
      { name: "name", type: "string" },
      { name: "start", type: "datetime", notNull: true, defaultValue: "now" },
